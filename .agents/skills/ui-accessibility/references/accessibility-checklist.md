...
Quick reference for WCAG 2.1 AA compliance. Use alongside the `ui-core` skill.
...
```bash
# Automated audit
pnpx axe-core          # Programmatic accessibility testing
pnpx pa11y             # CLI accessibility checker
