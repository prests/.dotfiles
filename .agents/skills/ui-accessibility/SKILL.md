...
```bash
pnpm add -D @axe-core/cli pa11y pa11y-ci
```
...
{
  "scripts": {
    "a11y:axe": "pnpx @axe-core/cli http://localhost:3000/route --save axe-report.json",
    "a11y:pa11y": "pnpx pa11y http://localhost:3000/route --reporter html > pa11y-report.html",
    "a11y:run": "pnpm run a11y:axe && pnpm run a11y:pa11y"
  }
}
```
