...
```bash
pnpx sanity schema extract && pnpx sanity typegen generate
```
...
```bash
pnpx sanity typegen generate --watch
```
...
```bash
pnpx sanity schema extract --enforce-required-fields
pnpx sanity typegen generate
```
