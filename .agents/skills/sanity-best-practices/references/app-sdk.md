...
```bash
# Basic quickstart
pnpx sanity@latest init --template app-quickstart --organization <your-org-id> --output-path . --typescript --skip-mcp

# With Sanity UI components
pnpx sanity@latest init --template app-sanity-ui --organization <your-org-id> --output-path . --typescript --skip-mcp
...
| Port 3333 in use | `pnpm run dev -- --port 3334` |
| Auth errors | `pnpx sanity@latest logout && pnpx sanity@latest login` |
