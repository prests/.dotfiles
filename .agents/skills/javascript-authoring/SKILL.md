...
- Install: `pnpm add -D eslint eslint-config-prettier`.
...
- Format: `pnpx prettier --write "src/**/*.js"`.
- Check: `pnpx prettier --check "src/**/*.js"`.
- Lint and fix: `pnpx eslint --fix "src/**/*.js"`.
